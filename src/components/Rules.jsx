                ...
                children={
                    <>
                        <div className="max-w-md">
                            <h1 className="text-2xl font-bold text-blue-600 text-center mb-5">Regler</h1>
                            ...
                            <h2 className="text-xl font-bold text-blue-600 mt-5">Om spelaren gissar fel</h2>
                            ...
                            <h2 className="text-xl font-bold text-blue-600 mt-5">Om spelaren gissar rätt</h2>
                            <p className="mt-2">
